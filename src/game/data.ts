...
export const AIRPORTS: Airport[] = [
  ...
  { id: 'bos', code: 'BOS', city: 'Boston', lat: 42.36, lon: -71.01, size: 5, population: 4_900_000, national: true },
  { id: 'jfk', code: 'JFK', city: 'New York', lat: 40.64, lon: -73.78, size: 6, population: 19_500_000, national: true },
  { id: 'atl', code: 'ATL', city: 'Atlanta', lat: 33.64, lon: -84.43, size: 6, population: 6_100_000, national: true },
  { id: 'mia', code: 'MIA', city: 'Miami', lat: 25.79, lon: -80.29, size: 5, population: 6_100_000, national: true },
  { id: 'ord', code: 'ORD', city: 'Chicago', lat: 41.98, lon: -87.9, size: 6, population: 9_400_000, national: true },
  { id: 'den', code: 'DEN', city: 'Denver', lat: 39.86, lon: -104.67, size: 4, population: 2_960_000, national: true },
  { id: 'lax', code: 'LAX', city: 'Los Angeles', lat: 33.94, lon: -118.41, size: 6, population: 13_200_000, national: true },
